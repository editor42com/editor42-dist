...
(function () {
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.PluginManager');
    ...
    const insertBlob = (editor, base64, blob) => {
      ...
      const blobInfo = blobCache.create(generate('editor42u'), blob, base64);
    ...
    var global = editor42.util.Tools.resolve('editor42.util.Delay');
      ...
      if (insertToolbarItems.length > 0) {
        editor.ui.registry.addContextToolbar('quickblock', {
          predicate: node => {
            ...
            return !has$1(sugarNode, 'data-editor42-bogus') && closest(sugarNode, 'table,[data-editor42-bogus="all"]', isRoot).fold(() => closest$1(sugarNode, elem => name(elem) in textBlockElementsMap && editor.dom.isEmpty(elem.dom), isRoot), never);
          },
    ...
    const addToEditor = editor => {
      ...
      const isImage = node => {
        ...
        const isPagebreak = has(SugarElement.fromDom(node), 'editor42-m-pagebreak');
