...
(function () {
    ...
    var global$6 = editor42.util.Tools.resolve('editor42.dom.RangeUtils');

    var global$5 = editor42.util.Tools.resolve('editor42.dom.TreeWalker');

    var global$4 = editor42.util.Tools.resolve('editor42.util.VK');
    ...
    var global$3 = editor42.util.Tools.resolve('editor42.dom.DOMUtils');
    ...
    const isEmpty$2 = (dom, elm, keepBookmarks) => {
      ...
      if (keepBookmarks && dom.select('span[data-editor42-type=bookmark]', elm).length > 0) {
        return false;
      }
      return empty;
    };
    ...
    const createTextBlock = (editor, contentNode) => {
      ...
      while (node = contentNode.firstChild) {
        ...
        if (!hasContentNode && (nodeName !== 'SPAN' || node.getAttribute('data-editor42-type') !== 'bookmark')) {
          hasContentNode = true;
        }
      ...
      if (!hasContentNode && textBlock) {
        textBlock.appendChild(dom.create('br', { 'data-editor42-bogus': '1' }));
      }
      return fragment;
    };
    ...
    const splitList = (editor, list, li) => {
      ...
      const bookmarks = DOM$2.select('span[data-editor42-type="bookmark"]', list);
    ...
    const isCustomList = list => /\beditor42-t\-/.test(list.className);
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.dom.BookmarkManager');
    ...
    const createBookmark = rng => {
      ...
      const setupEndPoint = start => {
        ...
        if (isElement(container)) {
          const offsetNode = DOM$1.create('span', { 'data-editor42-type': 'bookmark' });
      ...
      const restoreEndPoint = start => {
        const nodeIndex = container => {
          ...
          while (node) {
            ...
            if (!isElement(node) || node.getAttribute('data-editor42-type') !== 'bookmark') {
              idx++;
            }
      ...
      editor.windowManager.open({
        ...
        onSubmit: api => {
          ...
          parseStartValue(data.start).each(detail => {
            editor.execCommand('editor42ListUpdate', false, {
    ...
    const registerDialog = editor => {
      editor.addCommand('editor42ListProps', () => {
        open(editor);
      });
    };
    const register$2 = editor => {
      ...
      editor.addCommand('editor42ListUpdate', (ui, detail) => {
        if (isObject(detail)) {
    ...
    var global = editor42.util.Tools.resolve('editor42.html.Node');
    ...
    const register = editor => {
      const listProperties = {
        ...
        icon: 'ordered-list',
        onAction: () => editor.execCommand('editor42ListProps'),
