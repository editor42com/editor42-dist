...
(function () {
    ...
    const register$1 = editor => {
      editor.addCommand('editor42InsertDate', (_ui, value) => {
        insertDateTime(editor, value !== null && value !== void 0 ? value : getDateFormat(editor));
      });
      editor.addCommand('editor42InsertTime', (_ui, value) => {
    ...
    const register = editor => {
      ...
      const insertDateTime = format => editor.execCommand('editor42InsertDate', false, format);
