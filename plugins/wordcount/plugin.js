...
(function () {
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.dom.TreeWalker');
    ...
    const register$1 = (editor, api) => {
      editor.addCommand('editor42WordCount', () => open(editor, api));
    };
    ...
    const register = editor => {
      const onAction = () => editor.execCommand('editor42WordCount');
