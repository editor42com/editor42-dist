...
(function () {
    ...
    const accordionDetailsClass = 'editor42-m-accordion';
    const accordionSummaryClass = 'editor42-m-accordion-summary';
    const accordionBodyWrapperClass = 'editor42-m-accordion-body';
    const accordionBodyWrapperTag = 'div';

    var global$3 = editor42.util.Tools.resolve('editor42.util.Tools');
    ...
    const insertBogus = element => {
      element.innerHTML = '<br data-editor42-bogus="1" />';
      return element;
    };
    ...
    const insertAccordion = editor => {
      ...
      editor.undoManager.transact(() => {
        editor.insertContent([
          `<details data-editor42-id="${ uid }" class="${ accordionDetailsClass }" open="open">`,
          accordionSummaryHtml,
          accordionBodyHtml,
          `</details>`
        ].join(''));
        descendant(editorBody, `[data-editor42-id="${ uid }"]`).each(detailsElm => {
          remove$2(detailsElm, 'data-editor42-id');
    ...
    var global$2 = editor42.util.Tools.resolve('editor42.html.Node');
        ...
        parser.addNodeFilter(accordionTag, nodes => {
          for (let i = 0; i < nodes.length; i++) {
            ...
            if (isAccordionDetailsNode(node)) {
              ...
              newWrapperNode.attr('data-editor42-bogus', '1');
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.util.VK');
