...
(function () {
    ...
    var global$4 = editor42.util.Tools.resolve('editor42.PluginManager');
    ...
    var global$2 = editor42.util.Tools.resolve('editor42.util.URI');
    ...
    const isPlaceholderImage = imgElm => imgElm.nodeName === 'IMG' && (imgElm.hasAttribute('data-editor42-object') || imgElm.hasAttribute('data-editor42-placeholder'));
    ...
    const normalizeStyle = (image, normalizeCss) => {
      ...
      if (value.length > 0) {
        ...
        image.setAttribute('data-editor42-style', value);
      } else {
    ...
    const insertImageAtCaret = (editor, data) => {
      ...
      editor.dom.setAttrib(elm, 'data-editor42-id', '__editor42new');
      editor.focus();
      editor.selection.setContent(elm.outerHTML);
      const insertedElm = editor.dom.select('*[data-editor42-id="__editor42new"]')[0];
      editor.dom.setAttrib(insertedElm, 'data-editor42-id', null);
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.util.ImageUploader');
    ...
    const submitHandler = (editor, info, helpers) => api => {
      ...
      editor.execCommand('editor42UpdateImage', false, toImageData(finalData, info.hasAccessibilityOptions));
    ...
    const register$1 = editor => {
      editor.addCommand('editor42Image', Dialog(editor).open);
      editor.addCommand('editor42UpdateImage', (_ui, data) => {
    ...
    const register = editor => {
      editor.ui.registry.addToggleButton('image', {
        ...
        onSetup: buttonApi => {
          ...
          const unbindSelectorChanged = editor.selection.selectorChangedWithUnbind('img:not([data-editor42-object]):not([data-editor42-placeholder]),figure.image', buttonApi.setActive).unbind;
