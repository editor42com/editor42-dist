...
(function () {
    ...
    const insertNbsp = (editor, times) => {
      const classes = () => isVisualCharsEnabled(editor) ? 'editor42-m-nbsp-wrap editor42-m-nbsp' : 'editor42-m-nbsp-wrap';
    ...
    const register$1 = editor => {
      editor.addCommand('editor42NonBreaking', () => {
        insertNbsp(editor, 1);
      });
    };
    ...
    const register = editor => {
      const onAction = () => editor.execCommand('editor42NonBreaking');
