...
(function () {
    ...
    var global$5 = editor42.util.Tools.resolve('editor42.PluginManager');
    ...
    var global$4 = editor42.util.Tools.resolve('editor42.util.Tools');
    ...
    var global$3 = editor42.util.Tools.resolve('editor42.dom.TreeWalker');
    ...
    const getHref = elm => {
      var _a, _b;
      return (_b = (_a = elm.getAttribute('data-editor42-href')) !== null && _a !== void 0 ? _a : elm.getAttribute('href')) !== null && _b !== void 0 ? _b : '';
    };
    ...
    const isOnlyTextSelected = editor => {
      ...
      const isInBlockAnchor = getAnchorElement(editor).exists(anchor => anchor.hasAttribute('data-editor42-block'));
      if (isInBlockAnchor) {
        return false;
      }
    ...
    const createLink = (editor, selectedElm, text, linkAttrs) => {
      ...
      if (isImageFigure(selectedElm)) {
        ...
        text.fold(() => {
          editor.execCommand('editor42InsertLink', false, linkAttrs);
        }, text => {
    ...
    var global$1 = editor42.util.Tools.resolve('editor42.util.Delay');
    ...
    const register = editor => {
      editor.addCommand('editor42Link', (_ui, value) => {
    ...
    var global = editor42.util.Tools.resolve('editor42.util.VK');
    ...
    const openDialog = editor => () => {
      editor.execCommand('editor42Link', false, { dialog: true });
    };
    ...
    const setup = editor => {
      editor.addShortcut('Meta+K', '', () => {
        editor.execCommand('editor42Link');
      });
    };
