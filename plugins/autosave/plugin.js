...
(function () {
    ...
    var global$3 = editor42.util.Tools.resolve('editor42.util.Delay');

    var global$2 = editor42.util.Tools.resolve('editor42.util.LocalStorage');
    ...
    const register$1 = editor => {
      ...
      registerOption('autosave_prefix', {
        processor: 'string',
        default: 'editor42-autosave-{path}{query}{hash}-{id}-'
      });
