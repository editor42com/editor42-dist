...
(function () {
    ...
    const pageBreakClass = 'editor42-m-pagebreak';
    const getPlaceholderHtml = shouldSplitBlock => {
      const html = `<img src="${ global.transparentSrc }" class="${ pageBreakClass }" data-editor42-resize="false" data-editor42-placeholder />`;
    ...
    const register$1 = editor => {
      editor.addCommand('editor42PageBreak', () => {
    ...
    const register = editor => {
      const onAction = () => editor.execCommand('editor42PageBreak');
