...
(function () {
    ...
    const register$1 = editor => {
      editor.addCommand('editor42DirectionLTR', () => {
        setDir(editor, 'ltr');
      });
      editor.addCommand('editor42DirectionRTL', () => {
        setDir(editor, 'rtl');
      });
    };
    ...
    const register = editor => {
      editor.ui.registry.addToggleButton('ltr', {
        ...
        icon: 'ltr',
        onAction: () => editor.execCommand('editor42DirectionLTR'),
        onSetup: getNodeChangeHandler(editor, 'ltr')
      });
      editor.ui.registry.addToggleButton('rtl', {
        tooltip: 'Right to left',
        icon: 'rtl',
        onAction: () => editor.execCommand('editor42DirectionRTL'),
