    ...
    const setup = editor => {
      editor.on('PreProcess', e => {
        ...
        global.each(global.grep(pres, isCodeSample), elm => {
          ...
          dom.setAttrib(elm, 'data-editor42-highlighted', null);
          let child;
      ...
      editor.on('SetContent', () => {
        ...
        const unprocessedCodeSamples = global.grep(dom.select('pre'), elm => {
          return isCodeSample(elm) && dom.getAttrib(elm, 'data-editor42-highlighted') !== 'true';
        });
        if (unprocessedCodeSamples.length) {
          editor.undoManager.transact(() => {
            global.each(unprocessedCodeSamples, elm => {
              ...
              dom.setAttrib(elm, 'data-editor42-highlighted', true);
        ...
        editor.parser.addNodeFilter('pre', nodes => {
          ...
          for (let i = 0, l = nodes.length; i < l; i++) {
            ...
            if (isCodeSample) {
              ...
              node.attr('data-editor42-highlighted', 'false');
            }
          }
        });
      });
